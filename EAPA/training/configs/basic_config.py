...
def basic_config():
    ...
    config.dataset_cfg = dict(
        type="PromptDataset",
        meta_json_path='prompts/prompts/4k_training_prompts.json',
    ...
    # coefficient of the entropy constrain
    train.lamda = 200.0
    ...
    config.num_validation_images = 8
    config.eval_interval = 1
    
    #### logging ####
    # run name for wandb logging and checkpoint saving.
    config.run_name = ""
    config.wandb_project_name = 'EAPA'
